...
const Homescreen = (props) => {
	...
	const [RestoreList]             = useMutation(mutations.RESTORE_LIST);
	...
	const sortList = async (column) => {
		let transaction = new SortListItems_Transaction(activeList._id, column, SortList, RestoreList);
		props.tps.addTransaction(transaction);
		tpsRedo();
	};
