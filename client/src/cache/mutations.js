...
export const SORT_LIST = gql`
	mutation SortList($_id: String!, $column: String!){
		sortItems(_id: $_id, column: $column)
	}
`;

export const RESTORE_LIST = gql`
	mutation RestoreList($_id: String!, $oldList: [String]){
		restoreList(_id: $_id, oldList: $oldList)
	}
`;
